...
public class ControlServlet extends HttpServlet {
    ...
    public void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        ServletContextHashModel ftlServletContext = new ServletContextHashModel(this, FreeMarkerWorker.getDefaultNoerpWrapper());
    ...
    protected void configureBsf() {
        ...
        BSFManager.registerScriptingEngine("beanshell", "org.noerp.base.util.NoerpBshBsfEngine", bshExtensions);

        String[] jsExtensions = {"js"};
        BSFManager.registerScriptingEngine("javascript", "org.noerp.base.util.NoerpJsBsfEngine", jsExtensions);
