...
public class ContextFilter implements Filter {
    ...
    protected void putAllInitParametersInAttributes() {
        ...
        String GeronimoMultiNoerpInstances = (String) config.getServletContext().getAttribute("GeronimoMultiNoerpInstances");
        if (UtilValidate.isNotEmpty(GeronimoMultiNoerpInstances)) {
            String noerpHome = System.getProperty("noerp.home");
            if (GeronimoMultiNoerpInstances.equalsIgnoreCase("true") && UtilValidate.isEmpty(noerpHome)) {
                noerpHome = System.getProperty("noerp.home"); // This is only used in case of Geronimo or WASCE using NoERP multi-instances. It allows to retrieve noerp.home value set in JVM env
