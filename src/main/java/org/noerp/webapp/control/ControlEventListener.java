...
public class ControlEventListener implements HttpSessionListener {
    ...
    public void sessionCreated(HttpSessionEvent event) {
        ...
        if (System.getProperty("org.noerp.log.session.stats") != null) {
            session.setAttribute("org.noerp.log.session.stats", "Y");
        }
    ...
    public void logStats(HttpSession session, GenericValue visit) {
        if (Debug.verboseOn() || session.getAttribute("org.noerp.log.session.stats") != null) {
