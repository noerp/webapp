 ...
 * OFBiz URL builder.
 */
public final class NoerpUrlBuilder {

    public static final String module = NoerpUrlBuilder.class.getName();

    /**
     * Returns an <code>NoerpUrlBuilder</code> instance.
     * 
     * @param request
    ...
    /**
     * Returns an <code>NoerpUrlBuilder</code> instance. Use this method when you
     ...
     * @throws GenericEntityException
     */
    public static NoerpUrlBuilder from(WebappInfo webAppInfo, Delegator delegator) throws WebAppConfigurationException, IOException, SAXException, GenericEntityException {
        ...
        return new NoerpUrlBuilder(config, webSiteProps, servletPath);
    }
    ...
    private NoerpUrlBuilder(ControllerConfig config, WebSiteProperties webSiteProps, String servletPath) {
        this.config = config;
