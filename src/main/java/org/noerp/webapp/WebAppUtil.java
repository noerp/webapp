...
import org.noerp.base.util.UtilXml.LocalErrorHandler;
import org.noerp.base.util.UtilXml.LocalResolver;
...
public final class WebAppUtil {
     ...
     * specified in the <code>component.xml</code> file and the servlet mapping specified
    ...
    public static String getControlServletPath(WebappInfo webAppInfo) throws IOException, SAXException {
        ...
        for (ServletDef servletDef : webXml.getServlets().values()) {
            if ("org.noerp.webapp.control.ControlServlet".equals(servletDef.getServletClass())) {
        ...
        if (servletMapping == null) {
            throw new IllegalArgumentException("org.noerp.webapp.control.ControlServlet mapping not found in " + webAppInfo.getLocation() + webAppFileName);
        }
