 ...
 */
public class NoerpCurrencyTransform implements TemplateTransformModel {

    public static final String module = NoerpCurrencyTransform.class.getName();
    ...
    public Writer getWriter(final Writer out, Map args) {
        ...
        final BigDecimal amount = NoerpCurrencyTransform.getAmount(args, "amount");
        final String isoCode = NoerpCurrencyTransform.getArg(args, "isoCode");
        final String locale = NoerpCurrencyTransform.getArg(args, "locale");
