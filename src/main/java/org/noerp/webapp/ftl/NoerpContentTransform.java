 ...
 */
public class NoerpContentTransform implements TemplateTransformModel {

    public final static String module = NoerpContentTransform.class.getName();
    ...
    public Writer getWriter(final Writer out, Map args) {
        ...
        final String imgSize = NoerpContentTransform.getArg(args, "variant");
