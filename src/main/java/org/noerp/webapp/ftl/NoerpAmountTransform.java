...
/**
 * NoerpAmountTransform - Freemarker Transform for content links
 */
public class NoerpAmountTransform implements TemplateTransformModel {

    public static final String module = NoerpAmountTransform.class.getName();
    ...
    public Writer getWriter(final Writer out, Map args) {
        ...
        final Double amount = NoerpAmountTransform.getAmount(args, "amount");
        final String locale = NoerpAmountTransform.getArg(args, "locale");
        final String format = NoerpAmountTransform.getArg(args, "format");
        ...
        return new Writer(out) {
            ...
            public void close() throws IOException {
                try {
                    ...
                    if (format.equals(NoerpAmountTransform.SPELLED_OUT_FORMAT)) {
